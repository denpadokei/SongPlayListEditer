...
namespace SongPlayListEditer.UI.Views
{
    internal class SettingView : SingletonBindableBase<SettingView>
    {
        ...
        {
            get => PluginConfig.Instance?.ButtonIndex ?? 0;

            set => PluginConfig.Instance.ButtonIndex = value;
        }

        [UIValue("is-save-with-key")]
        public bool IsSaveWithKey
        {
            get => PluginConfig.Instance?.IsSaveWithKey ?? false;
